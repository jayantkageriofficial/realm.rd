    ...
    <>
      ...
      >
        <div className="px-6 py-2 mx-auto md:flex md:justify-between md:items-center">
          ...
          <div
            className={`absolute bg-secondary rounded-4xl mt-5 inset-x-0 z-10 w-full px-6 py-4 transition-all duration-300 ease-in-out  md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center ${
              isOpen
